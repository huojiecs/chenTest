...
Ext.onReady(function() {
	...
	var viewport = new Ext.Viewport({
		...
		items: [{
			region: 'north',
			height: 40,
			html: '<body><div style="position:relative;height:40px;line-height:40px;font-size:24px;color:#fff;background:#f8851f url(/ext-4.2.1-gpl/resources/themes/images/custom/icon.png) no-repeat 0 0;border-bottom:1px solid #c66a19;zoom:1;padding-left:48px;">鬼吹灯后台管理</div></body>'
		},
